...
namespace Chess.Models.Pieces
{
    internal class King : Piece
    {
        ...
        public override List<Move> GetPossibleMoves(bool isActiveMove)
        {
            ...
            {
                // King-side castling
                if (CheckCastlingConditionFulfilled(new Cell(7, 4), new Cell(7, 7), Helpers.GetCurrentGame(), Player))
                {
                    if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(7, 6), Helpers.GetCurrentGame(), Player))
                    {
                ...
                // Queen-side castling
                if (CheckCastlingConditionFulfilled(new Cell(7, 4), new Cell(7, 0), Helpers.GetCurrentGame(), Player))
                {
                    if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(7, 2), Helpers.GetCurrentGame(), Player))
                    {
            ...
            {
                // King-side castling
                if (CheckCastlingConditionFulfilled(new Cell(0, 4), new Cell(0, 7), Helpers.GetCurrentGame(), Player))
                {
                    if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(0, 6), Helpers.GetCurrentGame(), Player))
                    {
                ...
                // Queen-side castling
                if (CheckCastlingConditionFulfilled(new Cell(0, 4), new Cell(0, 0), Helpers.GetCurrentGame(), Player))
                {
                    if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(0, 2), Helpers.GetCurrentGame(), Player))
                    {
