...
namespace Chess.Models.Pieces
{
    internal class Pawn : Piece
    {
        ...
        public override List<Move> GetPossibleMoves(bool isActiveMove)
        {
            ...
            {
                if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(Position.Row + 1, Position.Col), Helpers.GetCurrentGame(), Player,
                    (r, c) => Helpers.GetCurrentGame().Board[r][c].Player == Player.None))
                {
                    AddPromotePawnIfValid(possibleMoves, new Cell(Position.Row + 1, Position.Col), isActiveMove);
                }
                if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(Position.Row + 1, Position.Col + 1), Helpers.GetCurrentGame(), Player,
                ...
                {
                    PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(Position.Row + 2, Position.Col), Helpers.GetCurrentGame(), Player,
                        (r, c) => Helpers.GetCurrentGame().Board[r][c].Player == Player.None);
                }
                ...
                if (Position.Row == 4)
                {
                    ...
                    {
                        if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(5, Position.Col - 1), Helpers.GetCurrentGame(), Player))
                        {
            ...
            if (Position.Row == 3)
            {
                ...
                {
                    if (PieceMoveHelpers.AddIfValid(possibleMoves, Position, new Cell(2, Position.Col - 1), Helpers.GetCurrentGame(), Player))
                    {
